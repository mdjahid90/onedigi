...
@if($enabled && $whatsappNumber !== '')
    <div
        ...
        data-wa-widget="1"
        style="--wa-right: {{ $right }}px; --wa-bottom-mobile: {{ $bottomMobile }}px; --wa-bottom-desktop: {{ $bottomDesktop }}px;"
        x-data="{
            open: false,
            message: @js($defaultMessage),
            wa: @js($whatsappNumber),
            send() {
    ...
    >
        ...
        >
            <div class="flex items-start justify-between gap-3 px-4 py-3" style="background-color: {{ $themeColor }};">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <div class="text-sm font-semibold text-white">{{ __('ui.whatsapp_us') }}</div>
                        <div class="text-xs text-white/90">{{ __('ui.typically_replies_fast') }}</div>
                    </div>
                </div>
            ...
            <div class="p-4">
                <label class="block text-xs font-semibold text-gray-700">{{ __('ui.message') }}</label>
                <textarea
                ...
                >
                    ...
                    <span>{{ __('ui.send_on_whatsapp') }}</span>
                </button>

                <div class="mt-2 text-[11px] text-gray-400">
                    {{ __('ui.whatsapp_opens_new_tab') }}
                </div>
            </div>
        </div>
