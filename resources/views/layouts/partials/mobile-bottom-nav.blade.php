    ...
    <nav class="sm:hidden fixed bottom-0 inset-x-0 z-50 pb-[env(safe-area-inset-bottom)]">
        <div class="mx-3 mb-3 rounded-2xl bg-white/70 backdrop-blur border border-white/40 shadow-lg">
            <div class="flex items-center justify-between py-2">
                <a href="{{ route('home') }}" class="flex flex-1 flex-col items-center justify-center gap-1 py-1 {{ request()->routeIs('home') ? 'text-indigo-600' : 'text-gray-600' }}">
                    ...
                    <span class="text-[11px] font-medium">{{ __('ui.home') }}</span>
                </a>

                <a href="{{ route('categories') }}" class="flex flex-1 flex-col items-center justify-center gap-1 py-1 {{ request()->routeIs('categories') ? 'text-indigo-600' : 'text-gray-600' }}">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="text-[11px] font-medium">{{ __('ui.categories') }}</span>
                </a>

                <a href="{{ route('products.index') }}" class="flex flex-1 flex-col items-center justify-center gap-1 py-1 {{ request()->routeIs('products.*') ? 'text-indigo-600' : 'text-gray-600' }}">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="text-[11px] font-medium">{{ __('ui.products') }}</span>
                </a>

                <a href="{{ route('orders') }}" class="flex flex-1 flex-col items-center justify-center gap-1 py-1 {{ request()->routeIs('orders') ? 'text-indigo-600' : 'text-gray-600' }}">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span class="text-[11px] font-medium">{{ __('ui.orders') }}</span>
                </a>

                <a href="{{ route('cart') }}" class="flex flex-1 flex-col items-center justify-center gap-1 py-1 {{ request()->routeIs('cart') ? 'text-indigo-600' : 'text-gray-600' }}">
                    ...
                    <span class="text-[11px] font-medium">{{ __('ui.cart') }}</span>
                </a>

                <a href="{{ auth()->check() ? route('dashboard') : route('login') }}" class="flex flex-1 flex-col items-center justify-center gap-1 py-1 {{ request()->routeIs('dashboard') ? 'text-indigo-600' : 'text-gray-600' }}">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
