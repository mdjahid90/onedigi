...
<?php endif; ?>
        ...
        <div class="mt-6">
            ...
            <a href="<?php echo e(route('auth.google')); ?>" class="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\digify\resources\views/auth/login.blade.php ENDPATH**/ ?>